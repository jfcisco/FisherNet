...
void DefaultMenu_setup() {
  ...
  button1.attachLongPressStart(BTN_1_confirm);
  ...
  button2.attachLongPressStart(BTN_2_confirm);
  ...
  button3.attachLongPressStart(BTN_3_confirm);
  ...
  button4.attachLongPressStart(BTN_4_confirm);
  ...
  button5.attachLongPressStart(BTN_5_confirm);
